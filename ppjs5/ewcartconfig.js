...
(function(P) {
	...
	P.MENUBAR_VERTICAL = false;
	P.MENUBAR_CLASSNAME = "yuimenubar yuimenubarnav";
	P.MENUBAR_ITEM_CLASSNAME = "yuimenubaritem";
	P.MENUBAR_ITEM_LABEL_CLASSNAME = "yuimenubaritemlabel";
	...
	P.BODY_TITLE = "PayPal Shop Maker 5";
	P.MENU_ID = "menu";	
	P.START_REC = "start";
	P.PAGE_NO = "page";
