...
<head>  
	...
	<link rel="stylesheet" href="/Images/simplecart/test/css/qunit.css" type="text/css" media="screen">  
	<script type="text/javascript" src="https://raw.github.com/jquery/qunit/master/qunit/qunit.js"></script>  
	<!-- Your project file goes here -->  
	<script type="text/javascript" src="/Images/simplecart/simpleCart.js"></script>  
...
<body>  
	...
	<ul>
		<li class="simpleCart_shelfItem">
			...
			<img class="item_thumb" src="/Images/simplecart/inc/e.png" />
