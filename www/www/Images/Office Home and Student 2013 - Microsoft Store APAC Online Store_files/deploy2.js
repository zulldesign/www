...
//PLUGINS_LIST=globalUtilsV2,simpleDeploy,sendLPVarsFromPage
...
lpMTagConfig.plugins['simpleDeploy'] = {
		...
		config : {
			...
			// dontSendIfEmpty : ["OrderTotal","OrderNumber"],
			// dontSendIfZero : ["OrderTotal","OrderNumber"],
			// scopeOverride : { "OrderTotal" : "page"},
			// varNameCharLimit : 50,
			// varValueCharLimit : 50,
			server : "sales.liveperson.net",
			buttons : [
				{"name":"chat-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language"),"pid":"lpChatDiv","afterStartPage":true,'ovr':'lpMTagConfig.db1'},
				{"name":"chat-store-service-zh-cn-bz","pid":"lpChatDiv2","afterStartPage":true,'ovr':'lpMTagConfig.db1'},
				{"name":"chat-store-sales-english-lpChatDiv3","pid":"lpChatDiv3","afterStartPage":true,'ovr':'lpMTagConfig.db1'},
				{"name":"chat-"+lpMTagConfig.getLPVarValue("unit")+"-"+lpMTagConfig.getLPVarValue("language")+"-4","pid":"lpChatDiv4","afterStartPage":true,'ovr':'lpMTagConfig.db1'}
			]
		}
};
...
lpMTagConfig.plugins['sendLPVarsFromPage'] = {
    ...
    config: {
        lpVarMappings: [
            {
                name: "videodesk_display",
                scope: "page",
                methods: [
                    {
                        type: "jsref",
                        jsref: "_videodesk.display"
                    }
                ]
            }
        ]
