...
HTMLArea.I18N = {
	...
	tooltips: {
		...
		copy:           "Копировать",
		paste:          "Вставить",
		lefttoright:    "Направление слева направо",
		righttoleft:    "Направление справа налево",
	...
	msg: {
		"Path":         "Путь",
		"TEXT_MODE":    "Вы находитесь в режиме отображения исходного html-кода.  Используйте кнопку [<>] для переключения обратно в режим WYSIWYG.",
