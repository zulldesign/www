...
<xsl:template name="mit_search_form">
  ...
  <xsl:param name="with_help_link"/>
	...
	<xsl:when test="contains($qval, 'site:')">
		...
		<input name="btnG" value="Search MIT" type="submit" />
		<xsl:text> 
		</xsl:text>
		...
		<br/>
<a href="http://web.mit.edu/search.html">Advanced Search</a> | <a href="http://web.mit.edu/google/www/basics.html">Help &amp; Search Tips</a>
		</xsl:when>
		<xsl:otherwise>
...
<a href="http://web.mit.edu/search.html">Advanced Search</a> | <a href="http://web.mit.edu/google/www/basics.html">Help &amp; Search Tips</a>
	...
	<xsl:otherwise>
		...
		<label><xsl:text>Offices</xsl:text></label> 
	     ...
	     <input name="btnG" value="Search MIT" type="submit" /><xsl:text> </xsl:text>
...
<xsl:template name="my_page_header">
	...
	<a href="http://web.mit.edu"><img src="http://web.mit.edu/img/google/google-mithome-logo.gif" title="Home" alt="Home - MIT" border="0" /></a> 
	<!-- begin search form -->
